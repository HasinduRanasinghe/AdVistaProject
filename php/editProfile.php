...
<body>
	...
	<div class="bodyDiv">
		...
		echo"<p> Contact Number : <input class=\"userProfileValues\" type=\"text\" name=\"newContactNumber\" value=\"$pn\" >";
		echo"<p> User Name      : <input class=\"userProfileValues\" type=\"text\" name=\"newUserName\" value=\"$userName\" >";
		echo'</form>';
		echo'</div>';
		echo'</div>';
		...
		echo'<center><a class="userProfileAnchors" href="../html/contactUs.html">Contact Us</a></center>';
		echo'</div>';
