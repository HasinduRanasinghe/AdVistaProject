...
<body>
	...
	<div class="bodyDiv">
		...
		<a href="../html/addFeedback.html"><input type="button" id="addFeedbackButton" name="addFeedback" value="Add Feedback"></a>
		...
		//starting connection with the database
			...
			if($resultSet->num_rows > 0)
			{
				while($row = $resultSet->fetch_assoc())
				{
					...
					$id = $row["ID"];
					echo "<img src=\"../images/feedbackImages/$id.jpg\" alt=\"image\">";
					echo '<p><font class="feedbackDoubleQuote">"</font>'. $row["description"] .'<font class="feedbackDoubleQuote">"</font></p>';
