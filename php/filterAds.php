...
// capturing the selected province 
...
if(isset($_GET['NorthWestern']))
	$province = "NorthWestern";

if(isset($_GET['Southern']))
	$province = "Southern";

if(isset($_GET['Sabaragamuwa']))
	$province = "Sabaragamuwa";

if(isset($_GET['Eastern']))
	$province = "Eastern";

if(isset($_GET['NorthCentral']))
	$province = "NorthCentral";

if(isset($_GET['Uwa']))
	$province = "Uwa";

if(isset($_GET['Northern']))
	$province = "Northern";
...
<body>
	...
	<div class="header">
		...
		<a class="websiteLogo" href="index.html">
	...
	<div class="bodyDiv">
		...
		<?php
			...
			$sqlCmd = "SELECT * FROM advertisement WHERE category = '$category' AND province = '$province'"; // fetching ads from the DB
			...
			if ($resultSet->num_rows > 0) { // if there is at least one advertisement
				...
				while ($row = $resultSet->fetch_assoc()) {
					...
					// displaying the advertisement card
			...
			else{ // if there is no any avertisement in the DB
