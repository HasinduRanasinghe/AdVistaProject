...
<body>
	...
	<div class="bodyDiv">
		...
		echo'<p> First Name     : <font class="userProfileValues">'.$firstName.'</font></p>';
		echo'<p> Last Name      : <font class="userProfileValues">'.$lastName.'</font></p>';
		echo'<p> Contact Number : <font class="userProfileValues">'.$pn.'</font></p>';
		echo'<p> Address        : <font class="userProfileValues">'.$strt1.'</font></p>';
		...
		echo'<center><a class="userProfileAnchors" href="../html/aboutUs.html">About Us</a></center>';
		echo'<center><a class="userProfileAnchors" href="../php/logout.php">Log Out</a></center>';
		echo'</div>';
		echo'<div class="profileInnerRow2">';
		
		echo'<center><p>This is your user profile page.</br> It contains all your personal information. </br>You can edit or delete your profile when needed.</p></center>';
		...
		$currentUserName = $_SESSION["currentUser"];
		$sqlCmd = "SELECT * FROM advertisement WHERE firstUsername = '$currentUserName'";
		$resultSet = $con->query($sqlCmd);

		if ($resultSet->num_rows > 0) {

			echo '<p class="myAds">My Advertisements</p>';
			...
			while ($row = $resultSet->fetch_assoc()) {
				...
				echo '<p class="ad-price"><strong>'.$row["price"].'/=</strong></p></br></br></br>';
				echo '<a class="seeMore" href="fullAd.php?adID='.$row["adID"].'">See More</a>';
				echo '<a class="seeMore" href="deleteAd.php?adID='.$row["adID"].'">Delete</a>';
				echo '</div>';
				echo '</div>';
			}	
		}
